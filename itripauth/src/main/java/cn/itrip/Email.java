...
public class Email {
    public static String account = "mdl2312024512@163.com";			//替换为发件人账号
    public static String password = "MYERWPFBFBMVPFVM";					//授权码

    public static String receiveMailAccount = "mdl2312024512@163.com";	//替换为收件人账号
    //CBSLYVLFDSUBQZEE
